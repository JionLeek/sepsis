...
def set_args():
    ...
    parser.add_argument("--predict_file_path", default="./release_model/lr_predict_log.csv", type=str)
    parser.add_argument("--model_path", default="./release_model/lr_v1.pickle", type=str)
