...
def set_args():
    ...
    parser.add_argument("--predict_file_path", default="./release_model/dnn_v1_predict.csv", type=str)
    parser.add_argument("--model_path", default="./release_model/dnn_v1.pickle", type=str)
    parser.add_argument("--label_hr", default=24, type=int)
